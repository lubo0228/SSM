	...
	<li><a href="javascript:void(0)" onclick="javascript:window.history.go(-1)">返回上级</a></li>
		...
		<div class="main">
			<ul id="myTab" class="nav nav-tabs">
				<li class="active"><a href="#tab1" data-toggle="tab">添加核销人员</a></li>
			</ul>
			...
			<div id="myTabContent" class="tab-content">
				<div class="tab-pane active" id="tab1">
								...
								<div class="form-group">
									...
									<div class="col-sm-8 col-lg-9">
										<input class="form-control userList" name="nickName"
											id="addExnickName" type="text" value="" placeholder="输入昵称点击搜索后才有人员列表">
									</div>
					...
					<div class=" panel panel-default">
						<div class="panel-heading"> <span>参加用户</span>
						</div>
									...
									<thead class="navbar-inner">
										...
										<tr>
											...
											<td><a href="javascript:void(0)"
													onclick="chooseExchangeUser(this)"
													class="btn  btn-default inUser" rel="tooltip"
													title="选为核销人员"> <i class="glyphicon glyphicon-user"></i>选为核销人员
											</a></td>
										</tr>
										</c:forEach>
									</thead>
...
/* 搜索fans表 */
function searchFans(){
	var nickName = $('#addExnickName').val();
	$.ajax({
		url : '${ctx}/wheel/user/searchFansToaddEx',
		data : {nickName:nickName},
		type : 'post',
		timeout : 0,
		success : function(result) {
			$('.right-content').html(result);
			$('#addExnickName').val(nickName);
		},
...
/* 选为核销人员 */
function chooseExchangeUser(obj) {
		...
		$.ajax({
			...
			success : function(result) {
				//console.log(result)
				if (result) {
					layer.alert("选为核销人员成功");
				} else {
					layer.alert("该用户已被选为核销人员");
				}
			},
			error : function(xhr, type, errorThrown) {
